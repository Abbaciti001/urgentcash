    ...
    <main className="min-h-screen flex justify-center py-4 md:py-6 md:px-12 lg:py-8 lg:px-16 bg-gray-100">
        ...
        p-2 md:p-6">
            <div className="flex justify-center">
              ...
              <p className="text-center py-3 border-b border-gray-600">Abbas Ashiru</p>
              <p className="text-center py-3 border-b border-gray-600">ashiruabbas2@gmail.com</p>
              <p className="text-center py-3 border-b border-gray-600">UC9002</p>
